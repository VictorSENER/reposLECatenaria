...
If Sheets(1).Cells(z, 16).Value = "Axe.Antich." And Sheets(1).Cells(z, 38).Value <> "Tunel" Then
    If rayo = "Parafoudres" Then
        ...
        Sheets(1).Cells(z, 14).Value = "Mise à la terre" '!!!!!!!!!!!!!!!!! debe ser variable desde BBDD
    ...
    ElseIf rayo = "Parafoudres + DPPo" Then
        ...
        Sheets(1).Cells(z, 14).Value = "Mise au rail + mise à la terre" '!!!!!!!!!!!!!!!!! debe ser variable desde BBDD
        rayo = "Parafoudres"
    End If
End If
...
If Sheets(1).Cells(z, 33).Value > tierra And Sheets(1).Cells(z, 38).Value <> "Tunel" Then
    ...
    Sheets(1).Cells(z, 14).Value = "Mise à la terre"
End If
