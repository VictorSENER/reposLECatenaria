...
Module ver_lac
    Sub ver_lac()
        ...
        Pantalla_datos.Text_d_max_ad.Enabled = False
        ...
        Pantalla_datos.Text_dist_horiz_equip_t.Enabled = False
        Pantalla_datos.Text_dist_vert_hc_anc.Enabled = False
        Pantalla_datos.Text_dist_vert_sust_anc.Enabled = False
        Pantalla_datos.Text_alt_cat_se_sm_el.Enabled = False
        Pantalla_datos.Text_alt_cat_e_sm.Enabled = False
        Pantalla_datos.Text_alt_cat_se_sla_el.Enabled = False
        Pantalla_datos.Text_alt_cat_e_sla.Enabled = False
        Pantalla_datos.Text_alt_cat_se_ag_el.Enabled = False
        Pantalla_datos.Text_alt_cat_e_ag.Enabled = False
        Pantalla_datos.Text_alt_cat_se_zn_el.Enabled = False
        Pantalla_datos.Text_alt_cat_e_zn.Enabled = False
        Pantalla_datos.Text_p_medio_equip_t.Enabled = False
        Pantalla_datos.Text_p_medio_equip_comp.Enabled = False
        Pantalla_datos.Combo_idioma.Enabled = False
        Pantalla_datos.Text_sep_hc.Enabled = False
        Pantalla_datos.Text_dist_horiz_equip_comp.Enabled = False
