...
public class PendoladoProgressPage extends SelectorComposer<Component>
{
    ...
    PendoladoVersion ver;
    PendoladoRevision rev;
    ...
    public void doAfterCompose(Component comp) throws Exception
    {
        ...
        ver = pendoladoService.getVersion(project, numVersion);
        rev = pendoladoService.getRevision(ver, numRevision);
    ...
    public void refreshGrid() throws Exception
    {
        ...
        String valores[] = pendoladoService.getProgressInfo(rev);
        double percentage;
