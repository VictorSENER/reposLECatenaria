...
ancho_medio_poste = 0.2 'valor estándar supuesto
...
'//
    ...
    End If
    If posicion_feed_pos = "Suspendido (lado vía)" Then
        dist_horiz_feed_pos = (dist_horiz_feed_pos)
    End If
    ...
    End If
    If posicion_feed_neg = "Suspendido (lado vía)" Then
        dist_horiz_feed_neg = (dist_horiz_feed_neg)
    End If
...
'//
'//CÁLCULO FUERZA RADIAL EN RECTA
'//
...
'//
'//CÁLCULO FUERZA RADIAL EN CURVA
'//
...
'//
'//MOMENTO POSTE SECCIONAMIENTO ELÉCTRICO
'//
