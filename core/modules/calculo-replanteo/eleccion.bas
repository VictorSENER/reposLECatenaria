...
'//
        ...
        End If
    End If
Call txt.progress("12", "14", "Elección poste", Sheets("Replanteo").Cells(fila, 33).Value - inicio, final - inicio)
...
'//
        ...
        End If
Call txt.progress("13", "14", "Elección cimentaciones", Sheets("Replanteo").Cells(z, 33).Value - inicio, final - inicio)
