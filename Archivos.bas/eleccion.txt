...
and_roz_terr = 22 'ángulo de rozamiento interno del terreno, valor a leer del sireca
tg_alpha = 0.005 'Valor máximo de inclinación del macizo
...
desm_terrap_mac = Sheets(9).Cells(i, 3)
    ...
    If mac_mac = "Paralelepípedo" Then
            ...
            'ACTIVAR CUANDO SE VINCULE CON EL PERFIL PARA ESCOGER DESMONTE O TERRAPLÉN
            'If dist_ad_mac >= 3.5 And desn_ad_mac < 0.5 And incl_ad_mac <= 19 Then '
            '    desm_terrap_mac = "desmonte"
                
            '    Else: desm_terrap_mac = "terraplén"
            'End If
             
                If desm_terrap_mac = "desmonte" Then
                    l_ent_mac = Sheets(9).Cells(i, 5) 'ancho cimentación en sentido perpendicular a la vía
                    ancho_ent_mac = Sheets(9).Cells(i, 6) 'ancho cimentación en sentido paralelo a la vía
                ...
                ElseIf desm_terrap_mac = "terraplén" Then
                    l_ent_mac = Sheets(9).Cells(i, 5) 'ancho cimentación en sentido perpendicular a la vía
                    ancho_ent_mac = Sheets(9).Cells(i, 6) 'ancho cimentación en sentido paralelo a la vía
                    l_tot_mac = Sheets(9).Cells(i, 7) 'ancho cimentación total en sentido perpendicular a la vía
    ...
    ElseIf mac_mac = "Cilíndrico" Then
        ...
        'ACTIVAR CUANDO SE VINCULE CON EL PERFIL PARA ESCOGER DESMONTE O TERRAPLÉN
            ...
            'End If
                ...
                If desm_terrap_mac = "desmonte" Then
                    diam_mac = Sheets(9).Cells(i, 15) 'ancho cimentación en sentido perpendicular a la vía
