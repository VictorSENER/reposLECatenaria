...
Module run
    ...
    Public Sub run_excel(ByVal inicio, ByVal fin, ByVal ruta_replanteo, ByVal nombre_excel, ByVal ruta_trazado)
        ...
        objExcel.Run("tabla_vanos.tabla_vanos", vw, diam_hc_cyc, diam_sust_cyc, diam_pend_cyc, va_max, r_min_traz, d_max_ad, d_max_cu, d_max_re, t_hc, t_sust, inc_norm_va, r_re, n_hc)
