...
End If
cadena_ruta = "C:\Users\23370\Documents\Proyectos\D223041 - SiReCa\DR_PLANOS\" & Sheets("Replanteo").Cells(1, 1).Value & " - " & Sheets("Replanteo").Cells(1, 2).Value & "\"
...
Sub dibujar_datos_poste(cadena_ruta)
...
End If
End Function
Sub dibujar_cantones(cadena_ruta)
'Dim pk_1 As Double
...
End Sub
Sub dibujar_descentramientos(cadena_ruta)
...
For iposte = 1 To num_postes_total
    ...
    If Sireca.CheckBox17.Value = True Then
        '///
        '/// Verificación del lado a implantar los datos en estacion
        '///
        If poste(iposte).aguja <> "" And cont_est = 0 Then
        ...
        Else
            dist_eje = (poste(iposte).implantacion + (ancho_via / 2) + (ancho_poste / 2) + ancho_carril + 5)
        End If
    ElseIf Sireca.CheckBox18.Value = True Then
...
Next
End Sub
Sub dibujar_implantacion(cadena_ruta)
...
Next
End Sub
Sub dibujar_flechas(cadena_ruta)
...
For iposte = 1 To num_postes_total
  ...
  Next iposte
End Sub
Sub dibujar_alturaHC(cadena_ruta)
Dim i As Integer
Dim alt As Single
...
Next
End Sub
Sub dibujar_etiquetas(cadena_ruta)
...
Sub dibujar_postes(cadena_ruta)
Dim alfa As Double
...
Sub dibujar_conexion(cadena_ruta)
Dim accapa As AcadLayer
...
Sub dibujar_proteccion(cadena_ruta)
...
Next iposte
End Sub
Sub dibujar_pendola(cadena_ruta)
...
Next
End Sub
Sub dibujar_alt_cat(cadena_ruta)
...
Next
End Sub
Sub dibujar_singular(cadena_ruta)
